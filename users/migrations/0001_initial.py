    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('NEW', 'NEW'), ('VERIFIED', 'VERIFIED'), ('DONE', 'DONE')], default='NEW', max_length=128)),
                ('user_role', models.CharField(choices=[('ADMIN', 'ADMIN'), ('ORDINARY_USER', 'ORDINARY_USER')], default='ORDINARY_USER', max_length=128)),
