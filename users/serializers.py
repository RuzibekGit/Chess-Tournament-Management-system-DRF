...
from users.models import UserModel, NEW, DONE, CODE_VERIFIED
...
class SignUpSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserModel
        fields = ['first_name', 'last_name', 'email', 'password', 'confirm_password', 'country', 'uuid', 'auth_status']
    ...
    def create(self, validated_data):
        ...
        send_code_to_email(user.email, code, name=user.name)
...
class UpdateUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserModel
        fields = ['first_name', 'last_name', 'username', 'phone_number', 'bio', 'age', 'country']
